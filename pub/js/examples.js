...
newQuiz.createTrueOrFalseQuestion(["Yellow is a primary color", "CPU stands for Central Processing Unit", "An Octopus has three hearts", "the letter A is the most common letter used in the English language."], [true, true, true, false]);
